...
class RestaurantCampaignList extends StatefulWidget {
  RestaurantCampaignList({@required this.campaign, @required this.database});//, @required this.onTap);
...
class _RestaurantCampaignList  extends State<RestaurantCampaignList > {
  ...
  void _navigateCampaignDetails(BuildContext context, CampaignModel campaign) {
     Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) {
          return CampaignDetailsPage(campaign: campaign, database: widget.database);
        },
      ),
    );
  }
                  ...
                  return Container(
                    child: widget.campaign[index].campaignType == "Momentarily"
                      ? Card(
                          elevation: 5,
                          child: InkWell(
                            onTap: () => _navigateCampaignDetails(context, widget.campaign[index]),
                           child: Container(
                            child: Row(
                              children: <Widget>[
                                CircleAvatar(
                                ...
                                Row(
                                  children: <Widget>[
                                    Column(
                                      children: <Widget>[
                                        Container(child: _showDuration(index)),
                                        Container(
